...
const QString BITCOIN_IPC_PREFIX("facekindle:");
// BIP70 payment protocol messages
const char* BIP70_MESSAGE_PAYMENTACK = "PaymentACK";
const char* BIP70_MESSAGE_PAYMENTREQUEST = "PaymentRequest";
// BIP71 payment protocol media types
const char* BIP71_MIMETYPE_PAYMENT = "application/facekindle-payment";
const char* BIP71_MIMETYPE_PAYMENTACK = "application/facekindle-paymentack";
const char* BIP71_MIMETYPE_PAYMENTREQUEST = "application/facekindle-paymentrequest";
    ...
    optionsModel(0)
{
    ...
    // on Mac: sent when you click facekindle: links
...
//
// OSX-specific way of handling facekindle: URIs and PaymentRequest mime types.
...
void PaymentServer::initNetManager()
{
    ...
    // netManager is used to fetch paymentrequests given in facekindle: URIs
