...
These are the dependencies currently used by Facekindle. You can find instructions for installing them in the `build-*.md` file for your platform.
...
Telegram - https://t.me/facekindlenl
Keybase  - https://keybase.io/team/facekindle/
