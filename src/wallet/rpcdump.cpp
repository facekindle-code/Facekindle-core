...
UniValue dumpprivkey(const UniValue& params, bool fHelp)
{
    ...
    if (fHelp || params.size() != 1)
        throw runtime_error(
            "dumpprivkey \"facekindleaddress\"\n"
            "\nReveals the private key corresponding to 'facekindleaddress'.\n"
            "Then the importprivkey can be used with this output\n"
            "\nArguments:\n"
            "1. \"facekindleaddress\"   (string, required) The facekindle address for the private key\n"
            "\nResult:\n"
