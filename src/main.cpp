...
#if defined(NDEBUG)
# error "Facekindle cannot be compiled without assertions."
#endif
...
const string strMessageMagic = "Facekindle Signed Message:\n";
                  ...
                  CCoinsViewCache& view, const CChainParams& chainparams, bool fJustCheck)
{
    ...
    // Facekindle also requires DER encoding of pubkeys
    flags |= SCRIPT_VERIFY_DERKEY;
    // Facekindle also requires low S in sigs
